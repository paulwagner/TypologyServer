...
@RunWith(Suite.class)
@Suite.SuiteClasses({ de.typology.db.DBToolsTest.class, de.typology.tools.AllTestsTools.class, de.typology.db.layer.AllTestsDBLayer.class, de.typology.rdb.connectors.AllTestsConnectors.class, 
