...
public class SBVEntryTest {
	...
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	@Test
	public void compareTo_IntegersLessAndGreater0_1() {
		int res = i_n1.compareTo(i_1);
		assertEquals("Compare int less and greater 0", res, 1);
	}
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	...
	public void compareTo_IntegersGreaterAndLess0_sign1() {
		...
		assertEquals("Compare int greater and less 0", res, -1);
	}
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	...
	public void compareTo_IntegersEquals0_0() {
		...
		assertEquals("Compare int equals 0", res, 0);
	}
	...
	public void compareTo_LongsLessAndGreater0_1() {
		...
		assertEquals("Compare long less and greater 0", res, 1);
	}
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	...
	public void compareTo_LongsGreaterAndLess0_sign1() {
		...
		assertEquals("Compare long greater and less 0", res, -1);
	}
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	...
	public void compareTo_LongsEquals0_0() {
		...
		assertEquals("Compare long equals 0", res, 0);
	}
	...
	public void compareTo_DoublesLessAndGreater0_1() {
		...
		assertEquals("Compare double less and greater 0", res, 1);
	}
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	...
	public void compareTo_DoublesGreaterAndLess0_sign1() {
		...
		assertEquals("Compare double greater and less 0", res, -1);
	}
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	...
	public void compareTo_DoublesEquals0_0() {
		...
		assertEquals("Compare double equals 0", res, 0);
	}	
	...
	public void compareTo_FloatsLessAndGreater0_1() {
		...
		assertEquals("Compare float less and greater 0", res, 1);
	}
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	...
	public void compareTo_FloatsGreaterAndLess0_sign1() {
		...
		assertEquals("Compare float greater and less 0", res, -1);
	}
	/**
	 * Test method for {@link de.typology.tools.SBVEntry#compareTo(de.typology.tools.SBVEntry)}.
	 */
	...
	public void compareTo_FloatsEquals0_0() {
		...
		assertEquals("Compare float equals 0", res, 0);
	}	
	...
	public void compareTo_StringEqualsM_0() {
		...
		assertEquals("Compare string equals m", res, 0);
	}		
